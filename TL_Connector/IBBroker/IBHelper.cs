            ...
            try
            {
                ...
                switch (mastersec.Type)
                {
                    ...
                    case TradeLink.API.SecurityType.FUT:
                        ...
                        DateTime date = Util.ToDateTime(symbolinstance.Date, 0);
                        debug("symbol:" + mastsymbol + "  Exchange:" + excode + "  Exprie:" + date.ToString("yyMMdd"));
                        return new Future(mastsymbol, excode, date.ToString("yyMMdd"));
                    default:
                        return null;
                }
            }
