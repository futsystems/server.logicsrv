 ...
 * */
    ...
    /// 
    /// </summary>
    public class TLBrokerCTPSplit : TLXBroker,IBroker
    {
        ...
        List<Order> SP_SplitOrder(Order o)
        {
            ...
            logger.Info("当前持仓数量 多头:" + longsize.ToString() + " 空头:" + shortsize.ToString() + "待买开:" + longPendingEntrySize.ToString() + " 待卖平:" + longPendingExitSize.ToString() + " 待卖开:" + shortPendingEntrySize.ToString() + " 待买平" + shortPendingExitSize.ToString() + " 委托操作持仓方向:" + (posside ? "多头" : "空头") + " 开平:" + (isEntry ? "开" : "平") + " 方向:" + (side ? "买入" : "卖出") + " 数量:" + o.UnsignedSize.ToString());
        ...
        {
            logger.Info("XAP[" + this.Token + "] 取消子委托:" + o.GetOrderInfo(true));
        ...
        public override void ProcessOrder(ref XOrderField order)
        {
            ...
            if (o != null)//本地记录了该委托 更新数量 状态 并对外发送
            {
                ...
                logger.Info("更新子委托:" + o.GetOrderInfo(true));
        ...
        public override void ProcessTrade(ref XTradeField trade)
        {
            ...
            if (o != null)
            {
                ...
                logger.Info("获得子成交:" + sonfill.GetTradeDetail());
                tk.GotFill(sonfill);
                //记录接口侧成交数据
