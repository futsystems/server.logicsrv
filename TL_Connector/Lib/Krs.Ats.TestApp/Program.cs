...
namespace Krs.Ats.TestApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            client.RequestMarketData(24, Google, null, false, false);
            client.RequestMarketDepth(25, Google, 5);
            client.RequestRealTimeBars(26, Google, 5, RealTimeBarType.Trades,false);
            client.RequestMarketData(27, EUR, null, false, false);
