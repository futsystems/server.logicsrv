...
{
    public class StrategyParameterConverter : TypeConverter
    {
        // Fields
        private StrategySettingTypeDescriptor xf51aebb9bcc93f27;

        // Methods
        public StrategyParameterConverter(StrategySettingTypeDescriptor info_td)
        {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if ((destinationType == typeof(String)) && (value is StrategyParameterInfo))
            {
                try
                {
                    StrategyParameterInfo p = value as StrategyParameterInfo;
                    return "值:"+p.Value.ToString();
