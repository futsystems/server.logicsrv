...
namespace FutSystems.GUI
{
    public class QuoteRow
    {
        ...
        //int[] _columnWidth;
        //int _totalWidth;
        public QuoteRow(ViewQuoteList quotelist,int rid, ref string[] columes,IntRetIntDel startfun,IntRetIntDel widthfun,RetIntDel rowwidthfun,RetIntDel beginIdxfun, QuoteStyle defaultQuoteStyle,string displayformat)//, CellStyle defaultCellStyle)
        {
