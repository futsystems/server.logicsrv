...
{
    public partial class ctDetailReportByAccount : UserControl
    {
        public ctDetailReportByAccount()
        {
            InitializeComponent();
            SetPreferences();
            InitTable();
            ...
            {
                //把自己注册到回调中心
                Globals.CallBackCentre.RegisterCallback("FinServiceCentre", "QryDetailReportByAccount", this.OnTotalReport);
        ...
        {
            this.Clear();
            Globals.TLClient.ReqQryTotalReportByDayRange(6, 20140101, 20141010);
        }
