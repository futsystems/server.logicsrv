...
namespace FutsMoniter
{
    partial class MainForm
    {
        ...
        void WireRibbon()
        {
            ...
            kryptonContextMenuItem_help.Click += new EventHandler(kryptonContextMenuItem_help_Click);
        ...
        void kryptonContextMenuItem_help_Click(object sender, EventArgs e)
        {
            MoniterUtils.OpenURL(Globals.Config["HelpURL"].AsString());
        }
