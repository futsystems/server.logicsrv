...
namespace FutsMoniter
{
    public partial class LoginForm : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        ...
        Starter mStart;
        string srvaddress = string.Empty;
        ...
        public LoginForm(Starter starter)
        {
            ...
            srvaddress = Globals.Config["Server"].AsString();
        ...
        { 
            ...
            btnClose.Click += new EventHandler(btnExit_LinkClicked);
            ...
            this.kryptonPanel2.MouseMove += new MouseEventHandler(kryptonPanel1_MouseMove);
            this.kryptonPanel2.MouseUp += new MouseEventHandler(kryptonPanel1_MouseUp);
            this.kryptonPanel2.MouseDown += new MouseEventHandler(kryptonPanel1_MouseDown);

            contractus.Click += new EventHandler(contractus_Click);
        }

        void contractus_Click(object sender, EventArgs e)
        {
            fmContractInfo fm = new fmContractInfo();
            fm.ShowDialog();
        }
