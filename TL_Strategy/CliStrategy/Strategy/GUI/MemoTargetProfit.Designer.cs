...
{
    partial class MemoTargetProfit
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.kryptonPanel1.Size = new System.Drawing.Size(360, 304);
            ...
            this.kryptonRichTextBox1.Text = "  止盈策略用于设定目标盈利点数,当价格达到入场成本价+目标盈利点数时,策略触发平仓\n1.手数:该策略所平仓数量,2手m1305,设定1手目标盈利出场,则当达到盈" +
                "利点数时,平仓1手.设定为0,则平掉所有仓位。\n2.点数:目标盈利点数,m1305,3615买入,点数20,则当价格达到3635的时,触发平仓";
            // 
            // MemoTargetProfit
            // 
