...
//{
//    public class RSMaxLossPercent : IAccountCheck
//    {
...
//            _profit = _percent * 0;// _acc.StartEquity / 100;//(初始权益)
//            bool ret = false;
...
//                        msg = "RSMaxLossPercent 账户:" + _acc.ID + "平仓未成功 再次平仓(" + _cancelnum.ToString() + ")";
...
//            get
//            {
//                return "账户损失比例 " + LibUtil.GetEnumDescription(_comparetype) + " " + _percent.ToString("N2") + "% [" + SymbolSet + "]" + " 强平仓位并禁止交易";
//            }
//        }
...
//        {
//            get { return "强平[亏损占初始权益]"; }
//        }
//        public static string Description
//        {
//            get { return "当最大损失占初始权益比例[Compare]设定百分比,系统将强平仓位并禁止账户交易(2%:参数填写2)"; }
//        }
