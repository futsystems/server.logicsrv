...
namespace TradingLib.Contrib.APIService
{
    ...
    public sealed class MobaopayMerchant
    {
        ...
        private void checkResult(string result,string key)
        {
            ...
            if (!MobaopaySignUtil.Instance.verifyData(signMsg, respData, key))
            {
        ...
        /// <returns></returns>
        public string transact(string requestStr, string serverUrl,string key)
        {
