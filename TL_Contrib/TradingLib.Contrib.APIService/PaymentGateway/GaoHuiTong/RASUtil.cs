...
namespace TradingLib.Contrib.Payment.GaoHuiTong
{
    public class RSAUtil
    {
        ...
        public static string sign(string content, string privateKey, string input_charset)
        {
            ...
            byte[] sbyte1 = Encoding.GetEncoding(input_charset).GetBytes(str);
            return Convert.ToBase64String(sbyte1);
        }
        ...
        public static bool JiJianverify(string content, string signedString, string publicKey, string input_charset)
        {
            ...
            cspParameters.KeyContainerName = "youtx";
            cspParameters.KeyNumber = 1;
            cspParameters.Flags = CspProviderFlags.UseMachineKeyStore;
            RSACryptoServiceProvider rsaPub = new RSACryptoServiceProvider(cspParameters);
            rsaPub.ImportParameters(paraPub);
            SHA1 sh = new SHA1CryptoServiceProvider();
            result = rsaPub.VerifyData(Data, sh, data);
            return result;
