    ...
    public class AcpService
    {
        ...
        public static void SignByCertInfo(Dictionary<string, string> reqData, string certPath, string certPwd, Encoding encoding)
        {
            ...
            if ("01".Equals(signMethod))
            {
                ...
                {
                    //stringData = "accessType=0&backUrl=http://180.118.234.247:9999/cash/srvnotify/unionpay&bizType=000201&certId=68759663125&channelType=08&currencyCode=156&encoding=UTF-8&frontUrl=http://180.118.234.247:9999/cash/custnotify/unionpay&merId=827320550940043&orderId=636422050864103596&payTimeout=20170928161509&signMethod=01&txnAmt=100&txnSubType=01&txnTime=20170928151509&txnType=01&version=5.1.0";

                    log.Info("data:" + stringData);
