...
namespace TradingLib.Contrib
{
    ...
    {
        public static QSEnumRaceType AccountRaceType(IAccount acc)
        {
            if (acc.RaceID.StartsWith("PRERACE")) return QSEnumRaceType.PRERACE;
            if (acc.RaceID == "SEMIRACE") return QSEnumRaceType.SEMIRACE;
            if (acc.RaceID == "REAL1") return QSEnumRaceType.REAL1;
            if (acc.RaceID == "REAL2") return QSEnumRaceType.REAL2;
            if (acc.RaceID == "REAL3") return QSEnumRaceType.REAL3;
            if (acc.RaceID == "REAL4") return QSEnumRaceType.REAL4;
            if (acc.RaceID == "REAL5") return QSEnumRaceType.REAL5;
        ...
        public static decimal EliminateEquity(QSEnumRaceType t)
        {
            ...
            {
                case QSEnumRaceType.PRERACE:
                    return 250000 * (1 + PRERACE_ELIMINATE);
                case QSEnumRaceType.SEMIRACE:
                    return 250000 * (1 + SEMIRACE_ELIMINATE);
                case QSEnumRaceType.REAL1:
                    return 250000 * (1 + REAL1_ELIMINATE);
                case QSEnumRaceType.REAL2:
                    return 500000 * (1 + REAL2_ELIMINATE);
                case QSEnumRaceType.REAL3:
                    return 1000000 * (1 + REAL3_ELIMINATE);
                case QSEnumRaceType.REAL4:
                    return 2000000 * (1 + REAL4_ELIMINATE);
                case QSEnumRaceType.REAL5:
                    return 3000000 * (1 + REAL5_ELIMINATE);
                default:
                    return 0;
            }
        }
        ...
        public static decimal PromptEquity(QSEnumRaceType t)
        {
            ...
            {
                case QSEnumRaceType.PRERACE:
                    return 250000 * (1 + PRERACE_PROMOT);
                case QSEnumRaceType.SEMIRACE:
                    return 250000 * (1 + SEMIRACE_PROMOT);
                case QSEnumRaceType.REAL1:
                    return 250000 * (1 + REAL1_PROMOT);
                case QSEnumRaceType.REAL2:
                    return 500000 * (1 + REAL2_PROMOT);
                case QSEnumRaceType.REAL3:
                    return 1000000 * (1 + REAL3_PROMOT);
                case QSEnumRaceType.REAL4:
                    return 2000000 * (1 + REAL4_PROMOT);
                case QSEnumRaceType.REAL5:
                    return 3000000 * (1 + REAL5_PROMOT);
                default:
                    return 0;
            }
        }
        ...
        public static QSEnumRaceCheckResult PRERACECheck(IAccount account)
        {
            ...
            decimal end = start + account.ObverseProfit;
