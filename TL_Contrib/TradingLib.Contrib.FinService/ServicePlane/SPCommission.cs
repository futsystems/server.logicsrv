...
namespace TradingLib.Contrib.FinService
{
    public class SPCommission : ServicePlanBase
    {
        ...
        /// </summary>
        [ArgumentAttribute("CutAmountInTrading", "盘中动态减额", EnumArgumentType.BOOLEAN, true, true, true)]
        public ArgumentPair CutAmountInTrading { get; set; }

        /// <summary>
        /// 收盘后如果自有资金不足应缴自有资金的50%时，自动降低配资额到1:10比例
        /// </summary>
        [ArgumentAttribute("CutAmountAfterSettle", "盘后动态减额", EnumArgumentType.BOOLEAN, true, true, true)]
