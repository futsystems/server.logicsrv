...
namespace Ant.Manager
{
    class Utils
    {
        ...
        public static Component.Progress FileProgress = new Component.Progress(520, 24);
        public static Component.Progress TotalProgress = new Component.Progress(520, 24);
    }
}
