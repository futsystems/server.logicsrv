...
namespace Ant.Update
{
    class Utils
    {
        ...
        public static Component.Progress FileProgress = new Component.Progress(298, 24);
        public static Component.Progress TotalProgress = new Component.Progress(298, 24);
