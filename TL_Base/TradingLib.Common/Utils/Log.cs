...
namespace TradingLib.Common
{
    ...
    public class Log
    {
        ...
        /// </summary>
		public string Content  { get { return "FN:"+getfn(_path, _logname, _dateinname)+" Content:"+_content.ToString(); } }
        /// <summary>
        /// create a log
        /// </summary>
        /// <param name="program"></param>
        public Log(string program) : this(program, true, true, Util.TLLogDir, true) { }
