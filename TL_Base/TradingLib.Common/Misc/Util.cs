...
namespace TradingLib.Common
{
    ...
    public class Util
    {
        ...
        /// <summary>
        /// official program name of the  suite
        /// </summary>
        public const string PROGRAM = "QuantShop";
        ...
        public static string GetConfigFile(string cfgname)
        {
            ...
            string filepath = Path.Combine(new string[] { path, "config", cfgname });
            return filepath;
        }
        /*
        /// <summary>
        ...
        */
        ...
        /// <summary>
        /// gets folder where  is installed
        /// </summary>
