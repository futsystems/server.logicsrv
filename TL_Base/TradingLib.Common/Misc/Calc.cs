...
namespace TradingLib.Common
{
    ...
    public static class Calc
    {
        ...
        public static decimal Avg(decimal[] array, int start, int len) { return Avg(array, true, start, len); }
        /// <summary>
        /// gets mean of an array
        /// </summary>
        /// <param name="array"></param>
        ...
        /// <returns></returns>
        public static decimal Avg(decimal[] array, bool returnzeroIfempty) { return Avg(array, returnzeroIfempty, 0, array.Length); }
        public static decimal Avg(decimal[] array, bool returnzeroIfempty, int start, int len) { return array.Length == 0 ? 0 : Calc.Sum(array, start, len) / len; }
        public static decimal Avg(int[] array) { return Avg(array, true); }
        public static decimal Avg(int[] array, int start, int len) { return Avg(array, true, start, len); }
        public static decimal Avg(int[] array, bool returnzeroIfempty) { return Avg(array, returnzeroIfempty, 0, array.Length); }
        public static decimal Avg(int[] array, bool returnzeroIfempty, int start, int len) { return array.Length == 0 ? 0 : (decimal)Calc.Sum(array, start, len) / len; }
        public static decimal Avg(long[] array) { return Avg(array, true); }
        public static decimal Avg(long[] array, int start, int len) { return Avg(array, true); }
        public static decimal Avg(long[] array, bool returnzeroifEmpty) { return Avg(array, returnzeroifEmpty, 0, array.Length); }
        ...
        /// <param name="array"></param>
        /// <returns></returns>
        public static double Avg(double[] array) { return Avg(array, 0,array.Length); }
        public static double Avg(double[] array, int start, int len) { return Avg(array, true, start, len); }
        /// <summary>
        /// gets mean of an array
        /// </summary>
        /// <param name="array"></param>
        /// <param name="returnzeroIfempty"></param>
        /// <returns></returns>
        public static double Avg(double[] array, bool returnzeroIfempty) { return Avg(array, returnzeroIfempty, 0, array.Length); }
        public static double Avg(double[] array, bool returnzeroIfempty, int start, int len) 
        { 
            return array.Length == 0 ? 0 : Calc.Sum(array, start, len) / len; 
        }
        ...
        public static decimal[] TrueRange(BarList chart)
        {
            ...
            for (int i = chart.Last; i > 0; i--)
            {
                Bar t = chart[i];
                Bar p = chart[i - 1];
                decimal max = (decimal)(t.High > p.Close ? t.High : p.Close);
                decimal min = (decimal)(t.Low < p.Close ? t.Low : p.Close);
                l.Add(max - min);
            }
            return l.ToArray();
        }
        ...
        {
            list.Sort(CompareListBigDecimal);
        }
        ...
        {
            list.Sort(CompareListSmallDecimal);
        
        }

        static int CompareListBigDecimal(decimal _a, decimal _b)//由大到小
        {
            decimal _temp = _a - _b;
            if (_temp < 0) return 1;
            if (_temp > 0) return -1;
        ...
        static int CompareListSmallDecimal(decimal _a, decimal _b)//由小到大
        {
            decimal _temp = _a - _b;
            if (_temp > 0) return 1;
            if (_temp < 0) return -1;
        ...
        /// <returns></returns>
        public static decimal ObverseProfit(decimal profit, decimal percent)
        {
            if (profit > 0)
            {
        ...
        /// <summary>
        /// 计算一组持仓的持仓成本
        /// 比如计算一组股票持仓的成本，期权持仓的成本[期权报价为点数,计算持仓时仍然需要乘以乘数,股票报价为实际报价,乘数就是1]
        /// </summary>
        /// <param name="positions"></param>
        /// <returns></returns>
