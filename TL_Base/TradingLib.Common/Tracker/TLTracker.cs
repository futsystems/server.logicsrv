...
//        /// <summary>
//        /// called when connection is made or refreshed 连接
//        /// </summary>
//        public event VoidDelegate GotConnect;
//        /// <summary>
//        /// called when disconnected 断开连接
//        /// </summary>
//        public event Int32Delegate GotDisConnect;
//        /// <summary>
//        /// called when no ticks have been received since timeout 连接错误
//        /// </summary>
//        public event VoidDelegate GotConnectFail;
//        /// <summary>
//        /// contains information useful for debugging 日志
//        /// </summary>
...
//            //client as 
//            //TLClient_IP f = client as TLClient_IP;
//            //f.GotDisconnectEvent += new Int32Delegate(onDisconnect);
//        }
...
//        /// <summary>
//        /// reconnect/refresh now 重新连接数据端
//        /// </summary>
//        public void Reconnect()
//        {
//            //debug("call in here");我们需要先关闭连接 然后才可以重新建立连接
//            _tl.Stop();
