...
{/*
    ...
    public class SecurityImpl : Security
    {
        ...
        /// create new security
        /// </summary>
        /// <param name="sym">合约字头</param>
        /// <param name="exchange">交易所</param>
        /// <param name="type">品种类别</param>
        ...
        {
            _sym = copy.Symbol;//合约字头
            _strike = copy.Strike;//行权价格
            _type = copy.Type;//类型
            _destex = copy.DestEx;//交易所
            _date = copy.Date;//日期
            _details = copy.Details;//细节 
        }
        ...
        /// <summary>
        /// name (symbol) of security 描述
        /// </summary>
        private string _description=string.Empty;
        public virtual string Description { get { return _description; } set { _description = value; } }

        //private string _mastsec = string.Empty;
        //[NonSerialized]
        //private Security _mastsec = null;
        //public virtual Security MasterSec { get { return _mastsec; } set { _mastsec = value; } }

        private decimal _entrycommission = 0;
        public virtual decimal EntryCommission { get { return _entrycommission; } set { _entrycommission = value; } }
        private decimal _exitcommission = 0;
        public virtual decimal ExitCommission { get { return _exitcommission; } set { _exitcommission = value; } }
        
        public virtual string Name { get { return _sym; }  }
        /// <summary>
        ...
        public CurrencyType Currency { get { return _currency; } set { _currency = value; } }
        ...
        /// 对应品种
        /// </summary>
        string _mastsec = null;
        public string MasterSecurity { get { return _mastsec; } set { _mastsec = value; } }
        /// <summary>
        /// serialize security as a string 将Security序列化成字符串
        /// </summary>
        ...
        public static SecurityImpl Parse(string msg, int date)
        {
            ...
            {
                //解析类别,如果类别为nil,则交易所也设置成nil
                int f1id = SecurityID(r[1]);
                if (f1id != -1)
                    sec.Type = (SecurityType)f1id;
                else sec.DestEx = r[1];
            }
            else //合约只包含 1个字段 则该合约为股票
                sec.Type = SecurityType.STK;

            //如果解析出的日期不为0 则设定到期日
            if (date!=0)
                sec.Date = date;
            //如果品种有关联交易所,并且合约没有指定类型,则从交易所推断出对应的品种信息
