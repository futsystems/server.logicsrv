...
//        //通过提供接口类型我们可以通过接口来查找我们实现的相应策略IPositioncheck,IStrategy等等
...
//        //检查是否是Response
//        //这里最后需要进行重构，精简代码
//        //最终我们需要检查是否继承了某个接口 IPositionCheck, IStrategy,IProperty等，因此这里我们可以从Object开始检查
//        static bool IsResponse(Type t)
//        {
//            return typeof(object).IsAssignableFrom(t);
//        }
