...
namespace TradingLib.BrokerXAPI
{
    ...
    public abstract class TLBroker :TLBrokerBase,IBroker,IDisposable
    {
        ...
        {
            Util.Debug("-----------TLBroker OnRtnOrderEvent----------------------- BrokerLocalID:"+pOrder.BrokerLocalOrderID+" BrokerRemoteID:"+pOrder.BrokerRemoteOrderID, QSEnumDebugLevel.INFO);
        ...
        {
            Util.Debug("-----------TLBroker OnRtnOrderErrorEvent-----------------------", QSEnumDebugLevel.INFO);
        ...
        {
            Util.Debug("-----------TLBroker OrderActionErrorEvent-----------------------", QSEnumDebugLevel.INFO);
        ...
        {
            Util.Debug("-----------TLBroker OnRtnTradeEvent-----------------------BrokerLocalID:"+pTrade.BrokerLocalOrderID +" BrokerRemoteID:"+pTrade.BrokerRemoteOrderID +" TradeID:"+pTrade.BrokerTradeID, QSEnumDebugLevel.INFO);
