...
namespace TradingLib.Core
{
    ...
    public class UIAccessTracker
    {
        ...
        static UIAccessTracker()
        {
            ...
            {
                _cfgdb.UpdateConfig("ExcludePermissionForAgent", QSEnumCfgType.String, "fm_debug,nav_system,nav_basic,nav_manager,nav_manager_permissionagent,nav_finance_cashercentre,moniter_router,moniter_acctype,moniter_tab_finance,moniter_menu_delaccount,fun_info_operation,fun_tab_placeorder,moniter_tab_config_inactive", "代理默认排除的权限列表");
            }
