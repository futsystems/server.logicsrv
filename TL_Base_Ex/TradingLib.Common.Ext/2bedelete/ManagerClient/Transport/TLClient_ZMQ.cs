...
//    public class TLClient_MQ_Moniter 
//    {
...
//        int _sendheartbeat = IPUtil.SENDHEARTBEATMS;//发送心跳请求间隔,该事件段内如果没有收到服务器的消息,则向服务器发起一次心跳请求
...
//        public event DataPubConnectDel DataPubConnectEvent;//Tick publisher成功
//        public event DataPubDisconnectDel DataPubDisconnectEvent;//Tick publisher成功
//        public event LoginResponseDel gotLoginRep;//账户回报
...
//        int _tickheartbeatdead = 6 * 1000;
//        int _tickprocesscheckfreq = 1000;//500 ms;
...
//                            //发送请求心跳响应
//                            TLSend(MessageTypes.HEARTBEATREQUEST, empytmessage);
//                        }
...
//        public TLClient_MQ(string[] servers, int ProviderIndex, int srvport,string tickserver,int tickport string Clientname, int disconnectretries, int wait, DebugDelegate deb, bool verbose)
//        {
...
//        public TLClient_MQ_Moniter(string[] servers, int srvport, string name, bool verbose)
//        {
...
//                    try
//                    {
//                        TLSend(MessageTypes.CLEARCLIENT, empytmessage);//向服务器发送clearClient消息用于注销客户端
//                        _mqcli.Disconnect();
//                        markdisconnect();
//                    }
//                    catch (Exception ex)
...
//                if (DataPubDisconnectEvent != null)
//                    DataPubDisconnectEvent();
...
//        MessageTypes[] _initfl = new MessageTypes[] { MessageTypes.REGISTERCLIENT, MessageTypes.CLEARCLIENT, MessageTypes.FEATUREREQUEST, MessageTypes.VERSION, MessageTypes.HEARTBEAT, MessageTypes.HEARTBEATREQUEST, MessageTypes.LOGINREQUEST };
//        public long TLSend(MessageTypes type, string m)
//        {
//            //debug("==>send meesage type:" + type.ToString() + " content:" + m);
//            //检查功能特征,若无该功能特征直接在本地拒绝该消息
//            //if (RequestFeatureList.Contains(type) || new List<MessageTypes>(_initfl).Contains(type))
//            {
...
//            //else
//            //{
//            //    debug(PROGRAME + ":not support feature:" + type.ToString() + " msg:" + m);
//            //    return -1;
//            // }
//        }
...
//        string empytmessage = IPUtil.EMPTYMESSAGE;
//        /// <summary>
//        /// 注册
//        /// </summary>
...
//            TLSend(MessageTypes.REGISTERCLIENT, empytmessage);
//        }
//        /// <summary>
//        /// 请求服务器版本
//        /// </summary>
...
//            TLSend(MessageTypes.VERSION, empytmessage);
//        }
//        /// <summary>
//        /// 请求brokername
//        /// </summary>
...
//        /// </summary>
//        /// <param name="mb"></param>
//        public void Subscribe(SymbolBasket mb = null)
//        {
...
//                debug("TLClient注册合约列表:" + mb.ToString());
//                /*
//                if (_lastbasekt != null)
//                {
//                    //原来注册的合约不在新合约列表则我们注销
//                    foreach (Security s in _lastbasekt)//上次注册的合约列表
//                    {
//                        if(!mb.HaveSymbol(s.Symbol))//如果当前注册的合约列表不包含原来的合约，则注销该合约
//                            debug("注销:" + s.Symbol);
//                            Unsubscribe_sub(s.Symbol);
//                    }
                    
//                }**/
//                UnsubscribeAll_sub();
//                TLSend(MessageTypes.REGISTERSTOCK, mb.ToString());//向交易服务器发送订阅列表,用于记录客户端订阅合约列表
//                //foreach (Security sec in mb)
//                //{
//                //    debug("订阅:" + sec.Symbol);
//                //    Subscribe_sub(sec.Symbol);//向行情服务器订阅对应的合约数据
//                //}
//                //新合约列表的合约不在老合约列表则我们注册
//                /*
//                    if (_lastbasekt != null)
//                    {
//                        foreach (Security sec in mb)
//                        {
//                            if (!_lastbasekt.HaveSymbol(sec.Symbol))
//                            {
//                                debug("订阅:" + sec.Symbol);
//                                Subscribe_sub(sec.Symbol);//向行情服务器订阅对应的合约数据
//                            }
...
//        {
//            //告诉服务端清除数据
//            TLSend(MessageTypes.CLEARSTOCKS, empytmessage);
//            UnsubscribeAll_sub();
...
//        {
//            return (int)TLSend(MessageTypes.HEARTBEAT, empytmessage);
//        }
...
//            TLSend(MessageTypes.DOMREQUEST, depth.ToString());
//        }
...
//            catch (Exception ex)
//            {
//                debug("Exception sending order: " + o.ToString() + " " + ex.ToString());
...
//            _rfl.Clear();
//            TLSend(MessageTypes.FEATUREREQUEST, empytmessage);
//        }
...
//        /// </summary>
//        /// <returns></returns>
//        public int RequestImbalances() { return (int)TLSend(MessageTypes.IMBALANCEREQUEST, empytmessage); }
//        /// <summary>
//        /// 请求持仓数据
//        /// </summary>
//        /// <param name="account">account to obtain position list for (required)</param>
//        /// <returns>number of positions to expect</returns>
//        public int RequestPositions(string account) { if (account == "") return 0; return (int)TLSend(MessageTypes.POSITIONREQUEST, account); }
...
//                    {
//                        _tickhartbeat = DateTime.Now.Ticks;
//                        //debug("tickheartbeat",QSEnumDebugLevel.MUST);
//                        break;
//                    }
//                /*
...
//                    {
//#if Debug
//                        debug(PROGRAME + ":#Got HEARTBEATRESPONSE:" + msg);
//#endif
//                        updateheartbeat();
...
//                    break;
//                //合约文件回报
//                case MessageTypes.SECURITYLISTFILEREP:
//                    {
//                        updateheartbeat();
//                        debug(PROGRAME + ":#Got SECURITYLISTFILEREP:" + msg);
...
//                    {
//                        updateheartbeat();
//                        //debug(PROGRAME + ":#Got LOGINRESPONSE REP:" + msg);
//                        try
//                        {
//                            if (gotLoginRep != null) gotLoginRep(Convert.ToBoolean(msg),"");
//                        }
//                        catch (Exception ex)
//                        {
//                            debug(PROGRAME + " error:" + ex.ToString());
