...
namespace TradingLib.Common
{
    public static partial class ManagerUtils
    {
        ...
        {
            int agentfk = manger.mgr_fk;
            return ORM.MAgentFinance.GetWithdrawOfTradingDay(agentfk, TLCtxHelper.ModuleSettleCentre.NextTradingday);
        }
        ...
        {
            int agentfk = manager.mgr_fk;
            return ORM.MAgentFinance.GetDepositOfTradingDay(agentfk, TLCtxHelper.ModuleSettleCentre.NextTradingday);
        }
        /// <summary>
        /// 获得某个代理某天的结算信息
        /// </summary>
