    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (false)
            {
                ...
                LCThostFtdcSettlementInfoField tmp3 = ByteSwapHelp.BytesToStruct<LCThostFtdcSettlementInfoField>(dstData, offset + Constanst.PROFTD_HDRLEN + Constanst.FTDC_HDRLEN);
                ...
                //将业务数据用本地方法打包
                byte[] data1 = StructHelperV12.PackRsp<LCThostFtdcSettlementInfoField>(ref tmp3, EnumSeqType.SeqQry, EnumTransactionID.T_RSP_USRINF, (int)tmp1.dReqId,(int)tmp1.dSeqNo);
